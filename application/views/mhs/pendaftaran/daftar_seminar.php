                                    ...
                                    <div class="tab-pane fade show active" id="lulus" role="tabpanel"
                                        ...
                                        <div class="row" align="center">
                                            <div class="col-3">
                                                ...
                                                <?php else: ?>
                                                <a target="_blank"
                                                    href="<?php echo base_url('assets/upload/pendaftaran/seminar/' .$lulus->DafsemFileTranskrip) ?>"><img
                                                        class="img-responsive"
                                                        src="<?php echo base_url('assets/img/umk/pdf.png') ?>"
                                                        alt="Transkrip" style="width:70px;height:70px;"></a>
                                                <?php endif ?>
                                            </div>
                                            ...
                                            <div class="col-3">
                                                ...
                                                <?php else: ?>
                                                <a target="_blank"
                                                    href="<?php echo base_url('assets/upload/pendaftaran/seminar/' .$lulus->DafsemFilePengesahan) ?>"><img
                                                        class="img-responsive"
                                                        src="<?php echo base_url('assets/img/umk/pdf.png') ?>"
                                                        alt="Pengesahan" style="width:70px;height:70px;"></a>
                                                <?php endif ?>
                                            </div>
                                            ...
                                            <div class="col-3">
                                                ...
                                                <?php else: ?>
                                                <a target="_blank"
                                                    href="<?php echo base_url('assets/upload/pendaftaran/seminar/' .$lulus->DafsemFileSlip) ?>"><img
                                                        class="img-responsive"
                                                        src="<?php echo base_url('assets/img/umk/pdf.png') ?>"
                                            ...
                                            <div class="col-3">
                                                ...
                                                <?php else: ?>
                                                <a target="_blank"
                                                    href="<?php echo base_url('assets/upload/pendaftaran/seminar/' .$lulus->DafsemFileBukubimbingan) ?>"><img
                                                        class="img-responsive"
                                                        src="<?php echo base_url('assets/img/umk/pdf.png') ?>"
                                                        alt="Buku Bimbingan" style="width:70px;height:70px;"></a>
                                                <?php endif ?>
                                            </div>
                                        </div>
                                        <br>
                                        <div class="row" align="center">
                                            <div class="col-3">
                                                ...
                                                <?php else: ?>
                                                <a target="_blank"
                                                    href="<?php echo base_url('assets/upload/pendaftaran/seminar/' .$lulus->DafsemFilePlagiasi) ?>"><img
                                                        class="img-responsive"
                                                        src="<?php echo base_url('assets/img/umk/pdf.png') ?>"
                                            ...
                                            <div class="col-3">
                                                ...
                                                <?php else: ?>
                                                <a target="_blank"
                                                    href="<?php echo base_url('assets/upload/pendaftaran/seminar/' .$lulus->DafsemFileKWKomputer) ?>"><img
                                                        class="img-responsive"
                                                        src="<?php echo base_url('assets/img/umk/pdf.png') ?>"
                                            ...
                                            <div class="col-3">
                                                ...
                                                <?php else: ?>
                                                <a target="_blank"
                                                    href="<?php echo base_url('assets/upload/pendaftaran/seminar/' .$lulus->DafsemFileKWInggris) ?>"><img
                                                        class="img-responsive"
                                                        src="<?php echo base_url('assets/img/umk/pdf.png') ?>"
                                            ...
                                            <div class="col-3">
                                                ...
                                                <?php else: ?>
                                                <a target="_blank"
                                                    href="<?php echo base_url('assets/upload/pendaftaran/seminar/' .$lulus->DafsemFileKWKewirausahaan) ?>"><img
                                                        class="img-responsive"
                                                        src="<?php echo base_url('assets/img/umk/pdf.png') ?>"
                            ...
                            <div class="card-body">
                                ...
                                <div class="tab-content" id="myTabContent5">
                                    ...
                                    <div class="tab-pane fade show active" id="upload" role="tabpanel"
                                        ...
                                        <div class="col-12">
                                            <form
                                                action="<?php echo base_url('mhs/pendaftaran/proses_daftar_seminar'); ?>"
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-6">
                                                            <div class="section-title mt-1">File Transkrip Acc Kaprodi
                                                            </div>
                                                            <div class="custom-file">
                                                                <input name="transkrip" type="file"
                                                                    class="custom-file-input">
                                                                <label class="custom-file-label">upload file
                                                                    .pdf</label>
                                                            </div>
                                                        </div>
                                                        <div class="col-6">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-6">
                                                            ...
                                                            <div class="custom-file">
                                                                <input name="pengesahan" type="file"
                                                                    class="custom-file-input">
                                                                <label class="custom-file-label">upload file
                                                                    .png</label>
                                                            </div>
                                    ...
                                    <div class="tab-pane fade" id="ket" role="tabpanel" aria-labelledby="ket-tab5">
                                        ...
                                        <div class="row" align="center">
                                            <div class="col-3">
                                                ...
                                                <?php else: ?>
                                                <a target="_blank"
                                                    href="<?php echo base_url('assets/upload/pendaftaran/seminar/' .$daftar_seminar['DafsemFileTranskrip']) ?>"><img
                                                        class="img-responsive"
                                                        src="<?php echo base_url('assets/img/umk/pdf.png') ?>"
                                                        alt="Transkrip" style="width:70px;height:70px;"></a>
                                                <?php endif ?>
                                            ...
                                            <div class="col-3">
                                                ...
                                                <?php else: ?>
                                                <a target="_blank"
                                                    href="<?php echo base_url('assets/upload/pendaftaran/seminar/' .$daftar_seminar['DafsemFilePengesahan']) ?>"><img
                                                        class="img-responsive"
                                                        src="<?php echo base_url('assets/img/umk/pdf.png') ?>"
                                                        alt="Pengesahan" style="width:70px;height:70px;"></a>
                                                <?php endif ?>
                                            ...
                                            <div class="col-3">
                                                ...
                                                <?php else: ?>
                                                <a target="_blank"
                                                    href="<?php echo base_url('assets/upload/pendaftaran/seminar/' .$daftar_seminar['DafsemFileSlip']) ?>"><img
                                                        class="img-responsive"
                                                        src="<?php echo base_url('assets/img/umk/pdf.png') ?>"
                                                        alt="Bukti Bayar" style="width:70px;height:70px;"></a>
                                                <?php endif ?>
                                            ...
                                            <div class="col-3">
                                                ...
                                                <?php else: ?>
                                                <a target="_blank"
                                                    href="<?php echo base_url('assets/upload/pendaftaran/seminar/' .$daftar_seminar['DafsemFileBukubimbingan']) ?>"><img
                                                        class="img-responsive"
                                                        src="<?php echo base_url('assets/img/umk/pdf.png') ?>"
                                                        alt="Buku Bimbingan" style="width:70px;height:70px;"></a>
                                                <?php endif ?>
                                        ...
                                        <div class="row" align="center">
                                            <div class="col-3">
                                                ...
                                                <?php else: ?>
                                                <a target="_blank"
                                                    href="<?php echo base_url('assets/upload/pendaftaran/seminar/' .$daftar_seminar['DafsemFilePlagiasi']) ?>"><img
                                                        class="img-responsive"
                                                        src="<?php echo base_url('assets/img/umk/pdf.png') ?>"
                                                        alt="Plagiasi" style="width:70px;height:70px;"></a>
                                                <?php endif ?>
                                            ...
                                            <div class="col-3">
                                                ...
                                                <?php else: ?>
                                                <a target="_blank"
                                                    href="<?php echo base_url('assets/upload/pendaftaran/seminar/' .$daftar_seminar['DafsemFileKWKomputer']) ?>"><img
                                                        class="img-responsive"
                                                        src="<?php echo base_url('assets/img/umk/pdf.png') ?>"
                                                        alt="KW Komputer" style="width:70px;height:70px;"></a>
                                                <?php endif ?>
                                            ...
                                            <div class="col-3">
                                                ...
                                                <?php else: ?>
                                                <a target="_blank"
                                                    href="<?php echo base_url('assets/upload/pendaftaran/seminar/' .$daftar_seminar['DafsemFileKWInggris']) ?>"><img
                                                        class="img-responsive"
                                                        src="<?php echo base_url('assets/img/umk/pdf.png') ?>"
                                                        alt="KW B.Inggris" style="width:70px;height:70px; "></a>
                                                <?php endif ?>
                                            ...
                                            <div class="col-3">
                                                ...
                                                <?php else: ?>
                                                <a target="_blank"
                                                    href="<?php echo base_url('assets/upload/pendaftaran/seminar/' .$daftar_seminar['DafsemFileKWKewirausahaan']) ?>"><img
                                                        class="img-responsive"
                                                        src="<?php echo base_url('assets/img/umk/pdf.png') ?>"
                                                        alt="KW Usaha" style="width:70px;height:70px;"></a>
                                                <?php endif ?>
