                ...
                <nav class="navbar navbar-expand">
                    <div class="collapse navbar-collapse justify-content-between">
                        <div class="header-left">
                            <?php
                            var_dump($status_akun->MhsStatus);
                            if ($status_akun->MhsStatus == 0) {
                            ?>
                        ...
                        <ul class="navbar-nav header-right">
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
                                    <img class="rounded mr-1" src="<?= base_url() ?>vendor/adminpanel/images/profile/17.jpg" width="20" alt="" />
                                    <div class="header-info">
                                        <span class="text-black"><strong><?php echo $this->session->userdata('MhsNama'); ?></strong></span>
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a href="<?= base_url() ?>vendor/adminpanel/email-inbox.html" class="dropdown-item ai-icon">
