							...
							<tr>
								...
								<td style="text-align: center">
									<div class="btn-group mb-3 btn-group-md" role="group">
										<a data-toggle="modal"
											data-target="#modaledit_<?php echo $this->enkripsi->encrypt_url($dosen->DosenId) ?>"
											href="<?php echo base_url('secure/master/edit_dosen/'.$this->enkripsi->encrypt_url($dosen->DosenId)); ?>"
											class="btn btn-sm btn-icon btn-info"><i class="far fa-edit"></i></a>
										...
										<a href="<?php echo base_url('secure/master/hapus_dosen/'.$this->enkripsi->encrypt_url($dosen->DosenId)); ?>"
											...
											data-confirm-yes="window.location.href='<?php echo base_url('secure/master/hapus_dosen/'.$this->enkripsi->encrypt_url($dosen->DosenId)); ?>' ">
...
<!-- Modal tambah dosen -->
<form action="<?php echo base_url('secure/master/tambah_dosen'); ?>" enctype="multipart/form-data" method="post"
						...
						<div class="row">
							...
							<div class="col-6">
								...
								<div class="input-group">
									...
									<input name="nohp" type="text" class="form-control phone-number" required="">
								</div>
							</div>
						</div>
						<br>
...
<!-- Modal edit dosen -->
<form action="<?php echo base_url('secure/master/edit_dosen'); ?>" enctype="multipart/form-data" method="post"
	accept-charset="utf-8" class="form-horizontal">

	<div class="modal fade" id="modaledit_<?php echo $this->enkripsi->encrypt_url($dosen['DosenId']) ?>" tabindex="-1"
				...
				<div class="modal-body">
					<div class="form-group">
						<div class="row">
							<div class="col-6">
								...
								<div class="input-group">
									...
									<input name="nidn" type="text" class="form-control daterange"
										value="<?php echo $dosen['DosenNidn'] ?>">
								</div>
							</div>
							<div class="col-6">
								<label>NO HP</label>
						...
						<textarea name="alamat" class="form-control" type="text"
							style="height: 70%;"><?php echo $dosen['DosenAlamat'] ?></textarea>
