                  ...
                  <?php if ($bimbingan) { ?>
                    <div class="row">
                      <div class="col-12 col-md-12 col-lg-12">
                        <div class="row">
                          <div class="col-6">
                            <button type="button" class="btn btn-success" data-toggle="modal" data-target="#modaladd1"><i class="fa fa-print"></i>
                              Bimbingan
                            </button>
                          </div>
                          <div class="col-6">
                        ...
                        <div class="card card-success">
                          <div class="card-header">
                            ...
                            <div class="card-header-action">
                              <a data-collapse="#1" class="btn btn-icon btn-info" href="#"><i class="fa fa-minus"></i></a>
                            </div>
                          </div>
  ...
  <div class="modal fade" id="modaladd1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <?php elseif (
          $cek_status1['BimbingansStatus'] == 1 && $cek_status1['BimbingansBab'] == 5 &&
        ...
        <?php elseif (
          $cek_status1['BimbingansStatus'] == 1 && $cek_status1['BimbingansBab'] == 'proposal' &&
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <select name="bab1" class="form-control">
                  ...
                  <?php elseif (
                    $cek_status1['BimbingansBab'] == null &&
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <select name="bab2" class="form-control">
                  <?php if (
                    $cek_status2['BimbingansBab'] == null &&
